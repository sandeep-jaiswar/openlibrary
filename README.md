...
- `@openlibrary/ui`: a stub React component library shared by both `web` and `docs` applications
- `@openlibrary/eslint-config`: `eslint` configurations (includes `eslint-config-next` and `eslint-config-prettier`)
- `@openlibrary/typescript-config`: `tsconfig.json`s used throughout the monorepo
